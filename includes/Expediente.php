<?php if ($EjecExpediente->num_rows > 0) { ?>
    ...
    <div class="container justify-content-center">
        ...
        <div class="row mt-3 text-center">
            ...
            <div class="col-sm-12 col-md-3 col-lg-3">
                <a href="./doc/Exp/<?php echo $DatosExp['DocDomicilio']; ?>" class="text-decoration-none text-warning" target="_blank">
                    <div class="card shadow bg-light mt-2">
                        <div class="row">
                            <div class="col mt-2 py-4">
                                <svg class='bi' width='30' height='30' fill='currentColor'>
            ...
            <div class="col-sm-12 col-md-3 col-lg-3">
                <a href="./doc/Exp/<?php echo $DatosExp['DocCredencial']; ?>" class="text-decoration-none text-warning" target="_blank">
                    <div class="card shadow bg-light mt-2">
                        <div class="row">
                            <div class="col mt-2 py-4">
                                <svg class='bi' width='30' height='30' fill='currentColor'>
    ...
    <div class="row mt-3">
        ...
        <?php } else { ?>
            ...
            <?php } ?>
            <?php $Lat = $DatosExp['Latitud'];
            $Log = $DatosExp['Longitud']; ?>
            <style>
                #mapa {
                    height: 300px;
                    width: 100%;
