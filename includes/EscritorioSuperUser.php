        ...
        <div class="card shadow bg-light container">
            <div class="row">
                ...
                <div class="col py-4 ms-2">
                    <strong class="fs-2"><?php echo $TUsuariosF; ?></strong>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="col-sm-6 col-md-3 col-lg-3 py-2">
        <div class="card shadow bg-light container">
            <div class="row">
                ...
                <div class="col py-4 ms-2">
                    <strong class="fs-2"><?php echo $TUsuariosP; ?></strong>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="col-sm-6 col-md-3 col-lg-3 py-2">
        <div class="card shadow bg-light container">
            <div class="row">
                ...
                <div class="col py-4 ms-2">
                    <strong class="fs-2"><?php echo $TSociosF; ?></strong>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="col-sm-6 col-md-3 col-lg-3 py-2">
        <div class="card shadow bg-light container">
            <div class="row">
                ...
                <div class="col py-4 ms-2">
                    <strong class="fs-2"><?php echo $TSociosP; ?></strong>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="col-sm-6 col-md-3 col-lg-3 py-2">
                <div class="card shadow bg-light container">
                    <div class="row">
                        ...
                        <div class="col py-4 ms-2">
                            <strong class="fs-2"><?php echo $Toficios; ?> </strong>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        data-bs-parent="#accordionFlushExample">
                            <div class="accordion-body">
                             <div class="row">
                                 ...
                                 <div class="col-sm-6 col-md-6 col-lg-6">2</div>
                             </div>
                            </div>
                        </div>
                    </div>
...
<script>
// funcion para pasar un json a un arreglo en javaScript 
...
var layout = {
    title: 'Tipo de Usuario por Fecha',
    xaxis: {
