...
<body>
    <div class="container py-4">
        <div class="row text-center">
            ...
            <div class="col-sm-6 col-md-6 col-lg-6 mt-3">
                <a href="#" class="text-decoration-none" data-bs-toggle="offcanvas" data-bs-target="#AyudaPass"
                    aria-controls="AyudaPass">
        ...
        <div class="row justify-content-center h-100 py-4">
            <div class="card shadow">
                <span class="text-muted text-center mt-3">
                    ...
                    </svg> Ingresa tu nombre de usuario junto con tu email registrado</span>
                <hr>
                <div class="row container justify-content-center">
                    ...
                    <div class="col-sm-6 col-md-6 col-lg-6">
                        <form action="<?php echo $_SERVER['PHP_SELF']; ?>" class="needs-validation" novalidate
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="text" class="form-control" name="usuario" placeholder="Usuario"
                                    aria-label="Usuario" aria-describedby="usuario" required>
