            ...
            <div class="container mt-3">
                <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST">
                    <div class="row mt-2 text-center">
                        <div class="col py-2">
                            <a href="appOficio.php" class="text-decoration-none text-muted"><svg class="bi text-danger"
                    ...
                    <div class="row  mt-5">
                        <div class="col-sm-12 col-md-12 col-lg-12 justify-content-center">
                            ...
                            <div class="form-floating">
                                <input type="text" class="form-control bg-light" placeholder="Titulo de la Notificacion"
                                    id="floatingTitulo" name="TituloNoti" required>
                                <label for="floatingTitulo">Titulo:</label>
                            </div>
                            <div class="form-floating mt-2">
                                <textarea class="form-control bg-light" placeholder="Mensaje a enviar"
                                    id="floatingTextarea" name="MensajeNoti" required></textarea>
                                <label for="floatingTextarea">Mensaje:</label>
                            </div>
                            <div class="d-grid gap-2 mt-3">
                                <input type="submit" name="NotiUsers"
                                    class="btn btn-sm btn-primary bg-gradient rounded-pill" value="Enviar Notificación">
                            </div>
                        </div>
                    </div>
                </form>
                        ...
                        <div class="Container">
                          ...
                          $fedit = date('d-m-Y'); ?>
                                            ...
                                            <td scope="col text-center">
                                                <a
                                                    href="includes/EliminarMensaje.php?Id_Mensajes=<?php echo $Lineas['Id_Mensajes'] ?>">
                                                    <svg class="bi text-danger" width="20" height="20"
                                                        fill="currentColor">
                                                        <use
                                                            xlink:href="library/icons/bootstrap-icons.svg#trash-fill" />
                                                    </svg>
                                                </a>
                                            </td>
                                        </tr>
